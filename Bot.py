...
""",
        ...
        "title": "🧑 معلم شیمی اوکیتا",
        "text": """

""",
    },"character_06": {
        "title": "🧑 راهنمای نام‌شخصیت",
        "text": """
...
""",
        ...
        "title": "🧑 ایوا",
        "text": """
۱. عصر به پارک برو و با ایوا صحبت کن.
۲. ۲ روز صبر کن.
۳. وقت ناهار به کافه‌تریای مدرسه برو.
۴. روز بعد در راهروی سمت راست مدرسه با ایوا حرف بزن و شب به Tattoo Parlor برو.
۵. ۲ روز صبر کن.
۶. در مدرسه پیشنهاد فرار از کلاس را قبول کن و به Tattoo Parlor برو.
۷. ۲ روز صبر کن.
۸. از رختکن پسرها دخترها را دید بزن، بعد در سالن اجتماعات با ایوا صحبت کن.
۹. ادامه مراحل Grace و Odette را انجام بده تا مسیر ایوا کامل شود.

پیش‌نیازها: کاریزما ۱۰، هوش ۵، چابکی ۵، کامپیوتر، ۳۰۰ دلار. 


""",
    },"character_10": {
        "title": "🧑 اودت دختر خوناشامی",
        "text": """
