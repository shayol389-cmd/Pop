...
AUTO_DELETE_SECONDS = 999999999999999         # بعد از چند ثانیه عکس/فایل/ویدیوی ارسالی خودکار پاک بشه
COUPONS_PER_REFERRAL = 5         # هر زیرمجموعه چند کوپن به معرف می‌ده
...
""",
    ...
    "character_05": {
        "title": " راهنمای خانم اوکیتا",
        "text": """
1. صبح‌ها در کلاس شیمی شرکت کن.


2. بعد از کلاس با Miss Okita صحبت کن.
...
5. مواد شیمیایی موردنیاز را از انبار بردار.


6. آزمایش اول را کامل کن.


7. روز بعد دوباره در کلاس حاضر شو.


8. آزمایش دوم را انجام بده.


9. مواد منفجره را طبق دستور آماده کن.


10. آزمایش را با موفقیت تمام کن.


11. روز بعد در کلاس شرکت کن.


12. با Miss Okita بعد از کلاس صحبت کن.


13. به دفتر او برو.


14. مأموریت تحقیق را دریافت کن.


15. وسایل موردنیاز را تهیه کن.


16. تحقیق را کامل کن.


17. روز بعد تحویل بده.


18. دوباره در کلاس حاضر شو.


19. رویداد آزمایشگاه را کامل کن.


20. شب به مدرسه برو.


21. وارد آزمایشگاه شو.


22. رویداد Miss Okita را کامل کن.


23. از این مرحله به بعد با شرکت در کلاس‌های شیمی و انجام رویدادهای جدید، ادامه مسیر تا پایان باز می‌شود.
...
CHARACTER_KEYWORDS = {
    ...
    "character_04": ["معلم فرانسه", " راهنمای خانم بیست"],
    "character_04": ["راهنمای معلم علوم", "اوکیتا"],
}
