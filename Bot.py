...
CHARACTER_KEYWORDS = {
    ...
    "character_04": ["بیست", "خانم بیست", "معلم فرانسه"],
    "character_05": ["اوکیتا", "خانم اوکیتا", "معلم شیمی"],
    "character_06": ["روز", "خانم روز", "معلم هنر"],
    "character_07": ["راهنمای نام‌شخصیت", "", "معلم موسیقی"],
    "character_08": ["roxxy", "روکسی", "راکسی"],
